...
function event_espresso_questions_config_mnu(){
	...
	if ($_REQUEST['update_sequence']=='true'){
          ...
          <thead>
            <tr>
              <th class="manage-column" id="cb" scope="col" ><input type="checkbox"></th>
               ...
               <th class="manage-column column-title" id="values" scope="col" title="Click to Sort" style="width:29%;">
                  <?php _e('Question','event_espresso'); ?>
                </th>
               <th class="manage-column column-title" id="values" scope="col" title="Click to Sort" style="width:30%;">
...
<?php 
	...
	/*if(  function_exists('espresso_member_data') && ( espresso_member_data('role')=='espresso_event_manager' || espresso_member_data('role')=='espresso_group_admin') ){
		$sql .= " WHERE wp_user = '" . espresso_member_data('id') ."' OR wp_user = 0";
	}*/
