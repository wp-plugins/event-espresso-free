...
<?php	if( function_exists('espresso_fb_createevent') == 'true' && $espresso_premium == true){	?>
      <div style="display: block;" id="event-meta" class="postbox">
		...
		<div class="inside">
			<input type="checkbox" name="espresso_fb" id="espresso_fb" /> <?php _e('Post to Facebook', 'event_espresso'); ?>
		</div>
	</div>     
<?php	}	?>
...
<?php 
	...
	?>
			<div style="display: block;" id="event-category" class="postbox">
              ...
              <h3 class="hndle"><span>
                <?php _e('Personnel Information','event_espresso'); ?>
                </span></h3>
              <div class="inside">
...
<?php echo get_option( 'event_espresso_re_active' ) == 1? '' :'<p><a href="http://eventespresso.com/?p=3319" target="_blank">'.__('Recurring Event Manager Now Available!', 'event_espresso').'</a></p>'; ?>
                </td>
            ...
            <tr valign="top">
             <?php if (function_exists( 'espresso_venue_dd' ) && $org_options['use_venue_manager'] == 'Y' && $espresso_premium == true){
              ...
              <td>
               ...
               <p>
                 <?php _e('Phone:','event_espresso'); ?>
                 <br /><input size="20"  type="text" tabindex="107" value="" name="phone" />
               </p>
               <p>
