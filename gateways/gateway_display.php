...
if (get_option('events_paypal_active') == 'true' || get_option('events_authnet_active') == 'true' || get_option('events_authnet_aim_active') == 'true' || get_option('events_alipay_active') == 'true' || get_option('events_mwarrior_active') == 'true'){
